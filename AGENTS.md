...
This file centralizes the established patterns, conventions, and best practices for any AI assistant contributing to the k0rdent Azure setup project. Use this alongside `CLAUDE.md` as reference when making changes or extending functionality.
